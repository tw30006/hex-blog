...
<template>
  ...
  <div class="banner banner-bottom">
    ...
    <div class="banner-bottom-content">
      ...
      <button
        type="button"
        class="banner-bottom-content-btn"
  ...
  <section class="container">
    ...
    <ul class="article-group">
      ...
      <li class="article-item">
        ...
        <div class="article-item-content">
          ...
          <p>
            當你從一人開發晉升到多人合作，版本控制的好壞往往決定了專案的順暢度。Git
            不僅能記錄程式碼變動，更能確保每位成員都在正確的分支上完成任務。透過這篇文章，你將了解常見的
            Git 流程，並學會在前端專案中輕鬆管理與協作。
          </p>
        </div>
        <button type="button" class="article-btn" @click="goToArticleDetail">
          閱讀內文
      ...
      <li class="article-item">
        ...
        <div class="article-item-content">
          ...
          <p>
            即使你的網站擁有優美的介面與強大的功能，如果在搜尋引擎上找不到它，那就形同隱形。身為前端工程師，瞭解基本的
            SEO
            概念與技術是讓網站脫穎而出的關鍵。這篇文章將分享我在前端實作時，常用的
            SEO 小技巧與實務做法，幫助你顯著提升網站曝光度。
          </p>
        </div>
        <button type="button" class="article-btn" @click="goToArticleDetail">
          閱讀內文
      ...
      <li class="article-item">
        ...
        <div class="article-item-content">
          ...
          <p>
            許多前端開發者在成長過程中都曾面臨動態語言帶來的錯誤風險，而
            TypeScript
            的出現正是為了改善這種情況。它能在開發階段即發現型別錯誤，並帶來更友善的程式碼提示。本篇文章將介紹如何在前端專案中導入
            TypeScript，並透過真實案例展示它為開發流程帶來的優勢。
          </p>
        </div>
    ...
    <div class="pagination">
      <svg
        ...
        height="16"
        fill="currentColor"
        class="bi bi-chevron-left last-page"
        viewBox="0 0 16 16"
      >
        <path
          fill-rule="evenodd"
      ...
      <svg
        ...
        height="16"
        fill="currentColor"
        class="bi bi-chevron-right next-page"
        viewBox="0 0 16 16"
      >
        <path
          fill-rule="evenodd"
